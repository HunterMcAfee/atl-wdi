...
SELECT COUNT(books.id) FROM books JOIN authors ON books.author_id = authors.id WHERE authors.name = 'Albert Camus';
...
SELECT * FROM authors WHERE authors.name LIKE 'J%';
